...
{
    /// <summary>
    /// Base instruction for all ADD instructions.
    /// All ADD instructions have two operands.
    /// Most of the time it's A
    /// </summary>
    public class InstructionADD : IInstruction
    {
        public string BaseInstruction { get; set; } = "ADD {0}, {1}";
